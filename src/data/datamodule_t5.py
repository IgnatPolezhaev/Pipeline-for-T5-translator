...
class DataManager:
    def __init__(self, data_config, model_config):
        ...
        self.source_tokenizer = T5Tokenizer(self.model_config, self.data_config, 'source')
        self.target_tokenizer = T5Tokenizer(self.model_config, self.data_config, 'target')
    ...
    def collate_wrapper(self, batch):
        ...
        tokenized_source = self.source_tokenizer(source_data)
        tokenized_target = self.target_tokenizer(target_data)
